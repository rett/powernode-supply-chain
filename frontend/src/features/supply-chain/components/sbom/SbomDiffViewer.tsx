        ...
        <Card className="p-6">
          ...
          <div className="space-y-2">
            {diff.added_components.map((component, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-3 bg-theme-success-bg rounded-lg"
              >
        ...
        <Card className="p-6">
          ...
          <div className="space-y-2">
            {diff.removed_components.map((component, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-3 bg-theme-error-bg rounded-lg"
              >
                <div className="flex items-center gap-3">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-2">
            {diff.changed_components.map((component, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-3 bg-theme-warning-bg rounded-lg"
              >
                <div className="flex items-center gap-3">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {diff.added_vulnerabilities.map((vuln, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-2 p-2 bg-theme-error-bg rounded"
                  >
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {diff.removed_vulnerabilities.map((vuln, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-2 p-2 bg-theme-success-bg rounded"
                  >
